<?php /* Smarty version 2.6.13, created on 2012-12-17 18:02:37
         compiled from application/admin/career/career_list.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'application/admin/career/career_list.html', 59, false),array('modifier', 'capitalize', 'application/admin/career/career_list.html', 74, false),)), $this); ?>

<div class="theContent">
    <div class="theTitle">
        <h2>Article List</h2>
        <a href="index.php?s=coorporate_career&act=excelreport&lid=<?php echo $this->_tpl_vars['lid']; ?>
...
" class="btn btn_document"><span>Download XLS</span></a>
        <a href="index.php?s=coorporate_career&act=add" class="btn btn_pencil"><span>Add New</span></a>
    </div><!--contenttitle-->
    <div class="tableoptions">
    
			<form> 
				<input type="hidden" name="s" value="coorporate_career" />
				<select name="lid">
...
?>
                        ...
                        <?php if ($this->_tpl_vars['v']['language_data'][$this->_tpl_vars['klang']] == 1): ?>
                            <a href="index.php?s=coorporate_career&act=edit&id=<?php echo $this->_tpl_vars['v']['parentid']; ?>
&lid=<?php echo $this->_tpl_vars['klang']; ?>
" style="text-decoration:none;"> update </a>
                            
                            &nbsp;| <a href="javascript:void(0)" class="popuppreview" url="http://axis-preview.kanadigital.com/corporate/index.php?page=karir&act=detail&id=<?php echo $this->_tpl_vars['v']['parentid']; ?>
" style="text-decoration:none;">preview</a> 
                            | <a href="index.php?s=coorporate_career&act=hapus&parentid=<?php echo $this->_tpl_vars['v']['parentid']; ?>
" style="text-decoration:none;" onclick="return confirm('Are you sure you want to delete this?')">delete</a>
                            </p><hr>
                        <?php else: ?>
                            <a href="index.php?s=coorporate_career&act=add_language&id=<?php echo $this->_tpl_vars['v']['parentid']; ?>
