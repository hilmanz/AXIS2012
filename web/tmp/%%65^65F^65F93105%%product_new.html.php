<?php /* Smarty version 2.6.13, created on 2012-12-17 16:22:34
         compiled from application/admin/Product/product_new.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'capitalize', 'application/admin/Product/product_new.html', 120, false),)), $this); ?>
...
"><?php echo $this->_tpl_vars['type'][$this->_sections['i']['index']]['type']; ?>
		...
		<tr class="head">
			...
			<td><input type="text" id="myUrl" name="myUrl" style="width:500px;" /></td>
		</tr>
		<tr class="head">
