<?php /* Smarty version 2.6.13, created on 2012-12-17 17:27:21
         compiled from application/admin/isi_pulsa/isi_pulsa_list.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'application/admin/isi_pulsa/isi_pulsa_list.html', 55, false),array('modifier', 'capitalize', 'application/admin/isi_pulsa/isi_pulsa_list.html', 68, false),)), $this); ?>

<div class="theContent">
    <div class="theTitle">
        <h2>ISI Pulsa Content</h2>
        <a href="index.php?s=isi_pulsa&act=excelreport&lid=<?php echo $this->_tpl_vars['lid']; ?>
...
" class="btn btn_document"><span>Download XLS</span></a>
        <a href="index.php?s=isi_pulsa&act=add" class="btn btn_pencil"><span>Add New</span></a>
    </div><!--contenttitle-->
...
"/>
            <input type="hidden" name="s" value="isi_pulsa" />
...
public_assets/isi_pulsa/tiny_<?php echo $this->_tpl_vars['v']['image']; ?>
" /><?php endif; ?></td>
...
?>
                        ...
                        <?php if ($this->_tpl_vars['v']['language_data'][$this->_tpl_vars['klang']] == 1): ?>
                            <a href="index.php?s=isi_pulsa&act=edit&id=<?php echo $this->_tpl_vars['v']['parentid']; ?>
&lid=<?php echo $this->_tpl_vars['klang']; ?>
" style="text-decoration:none;"> update </a>
                            
                            &nbsp;| <a href="javascript:void(0)" class="popuppreview" url="http://axis-preview.kanadigital.com/index.php?page=isi_ulang" style="text-decoration:none;">preview</a> 
                            | <a href="index.php?s=isi_pulsa&act=hapus&parentid=<?php echo $this->_tpl_vars['v']['parentid']; ?>
" style="text-decoration:none;" onclick="return confirm('Are you sure you want to delete this?')">delete</a>
                            </p><hr>
                        <?php else: ?>
                            <a href="index.php?s=isi_pulsa&act=add_language&id=<?php echo $this->_tpl_vars['v']['parentid']; ?>
