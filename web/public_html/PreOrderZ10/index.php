...
.tulisan18 {font: 26px 'HelveticaLTStd-Light', arial, san-serif; color:#000; }
...
?>
<script>
 var _launchts = <?=getTime()?>;

			jQuery(document).ready(function() {
						
				var _launchdate = {
						'day': 		parseInt(_launchts.day,10),
						'month': 	parseInt(_launchts.month,10),
						'year': 	parseInt(_launchts.year,10),
						'hour': 	parseInt(_launchts.hour,10),
						'min': 		parseInt(_launchts.min,10),
						'sec': 		parseInt(_launchts.sec,10)
					}
				...
				$('#countdown_dashboard').countDown({
					...
					onComplete: function() 
					{ 
						location.href = window.reload(); /* do something */
					}
				});
    ...
    <td height="89" valign="top" style="background:url(images/dotted.gif) repeat-x bottom;"><table width="900" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="130" align="right" valign="middle"><table width="100" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><?php if($_REQUEST['ver']=="eng" or $_REQUEST['ver']=="") { ?><img src="images/en.gif" width="36" height="12" border="0" style="border:0" /><?php } else { ?><a href="index.php?ver=eng"><img src="images/en1.gif" width="36" height="12"  style="border:0" /></a><?php } ?></td>
            <td><?php if($_REQUEST['ver']=="ind") { ?><img  style="border:0" src="images/id.gif" width="36" height="12" border="0" /><?php } else { ?><a href="index.php?ver=ind"><img  style="border:0" src="images/id1.gif" width="36" height="12" /></a><?php } ?></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="444" valign="top"><table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="462" height="434" align="center" valign="middle"><img src="images/bb10.png" width="352" height="400" /><br /></td>
