<?php
	$META_TITLE = 'Yang Lagi In - Axis';			// Meta Title
	$PAGE_ID = 'page-hot';							// ID for the body tag
	include '_header.php';
?>
	...
	<div class="page-body" data-role="content">
		...
		<script type="text/javascript">
		    $('#page-hot').live( 'pageshow', function(e){
		...
		<div class="list-nav">
			<ul data-role="listview" data-inset="true">
				<li>
					<a href="hot-promo.php" data-transition="slide">
