<?php
	$META_TITLE = 'Ibadah nyaman tak perlu ganti kartu - Axis';			// Meta Title
	$PAGE_ID = 'page-hot-promo-detail';									// ID for the body tag
	include '_header.php';
?>
	...
	<div class="page-body" data-role="content">
		...
		<div class="page-image-heading">
			<img src="assets/images/heading-ibadah-nyaman.jpg" alt="Ibadah nyaman tak perlu ganti kartu" />
		</div>
		
		<div class="page-meta">
			<h1 class="page-title"><span class="icon"></span>AXIS HAJI</h1>
		...
		<div class="list-nav">
			<ul data-role="listview" data-inset="true">
				<li>
					<a href="hot-promo.php" data-transition="slide" data-rel="back">
