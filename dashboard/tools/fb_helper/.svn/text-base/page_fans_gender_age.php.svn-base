<?php
	set_time_limit(0);
require "config.php";
  $my_url = "http://nonatetramedia.com/fb/page_fans_gender_age.php"; //=> set your redirect url
  ...
  // success
	...
	foreach($arr as $i=> $a){
		foreach($a as $k=> $de){
			$q = "INSERT IGNORE INTO fb_".$metrix." (proID,day,demografi,value) 
					VALUES ('".$proID."','".$i."','".$k."','".$de."')";
			if(mysql_query($q)){
				echo  $q." => SUKSES<br>";
			}else{
