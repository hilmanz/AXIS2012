...
//dropdown menu page
function GetDropDownMenu($req=false,$app,$view){
 ...
 * @param $user_id
 */
function get_access_token($user_id,$api_key,$action="/",$unlimited=false){
	$access_token = urlencode64(serialize(array("user_id"=>$user_id,
					"api_key"=>$api_key,
					"expired"=>time()+120,
					"unlimited"=>$unlimited,
					'action'=>$action,
