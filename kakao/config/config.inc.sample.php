...
define('TEMPLATE_DOMAIN_WEB',APPLICATION."/kakaoweb/");
...
$CONFIG['TEASER_DOMAIN'] =  "http://localhost/kakao/trunk/web/public_html/";
$CONFIG['MAINTENANCE'] = false;
$CONFIG['BASE_DOMAIN'] = "http://localhost/kakao/trunk/web/public_html/";
$CONFIG['COORPORATE_DOMAIN'] = "http://localhost/kakao/trunk/web/coorporate_html/";
$CONFIG['Postpaid_OnlineRegistration'] = "https://localhost/kakao/trunk/web/Postpaid_OnlineRegistration/";
$CONFIG['Prepaid_Registrations'] = "https://localhost/kakao/trunk/web/Prepaid_Registrations/";
...
$CONFIG['LOCAL_PUBLIC_ASSET'] = "/home/kana/kanadigital/preview/kakao/public_html/public_assets/";

$CONFIG['LANDING_BASE_DOMAIN'] = "http://localhost/kakao/trunk/web/public_html/";
$CONFIG['MOBILE_SITE'] =  "http://localhost/kakao/trunk/web/public_html/mobile/";

$CONFIG['VIEW_ON']  = 1;

//SOCIAL MEDIA
//testing
$FB['appID'] = "390107777736807";
$FB['appSecret'] = "1a7addd1e58c2bbfc0e14b50806f6a1f";
...
$GPLUS['redirect_url'] = 'http://localhost/kakao/trunk/web/public_html/?loginType=google';
...
if($local){
	...
	$CONFIG['DATABASE'][0]['DATABASE'] 	= "kakao_web_2012";
...
$CONFIG['SERVICE_KEY'] = sha1("kakaoweb2012");


/**
 * Email settings
 */
$CONFIG['EMAIL_FROM_DEFAULT'] = "noreply-kakaoweb2012@codebook.com";
...
$CONFIG['email_axis'] = 'axis_test@axisword.co.id';
